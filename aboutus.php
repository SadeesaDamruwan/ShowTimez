...
<head>
    ...
    <title>ShowTimez | ABOUT US</title>
...
<body>
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-white text-primary display-5"
                            href="index.php">ShowTimez</a></span>
                </div>
    ...
    <section data-bs-version="5.1" class="header6 cid-trwrLaEjhn"
        data-bg-video="https://vimeo.com/manage/videos/1082452037" id="header6-1v">
        ...
        <div class="align-center container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    ...
                    NSBM Green University, located in Pitipana, Homagama, is Sri Lanka’s first-ever green university and a leader 
                    in higher education, offering internationally recognized degree programs in Business, Computing,
                     Engineering, Science, and Design. The university is known for its state-of-the-art infrastructure, eco-friendly 
                     campus, and strong academic partnerships with prestigious global universities. NSBM emphasizes 
                     innovation, entrepreneurship, and holistic student development, preparing graduates to thrive in both local 
                     and international industries.
                    </p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="https://www.nsbm.ac.lk//" target="_blank">Visit Now!</a></div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="embla__container">
                        ...
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="user">
                                <div class="user_image">
                                    <div class="item-wrapper position-relative">
                                        <img src="assets\images\WhatsApp Image 2025-05-08 at 13.04.32_9dc9e3d0.jpg"
                                            alt="  " data-slide-to="4" data-bs-slide-to="4">
                                    </div>
                                </div>
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7">I'm Damruwan M.S. , an undergraduate student
                                        studying in NSBM Green University pursuing the BSC in Computer Science degree program
                                        </p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7"><strong>Damruwan M.S.</strong></div>
                                <div class="user_desk mbr-fonts-style display-7">DEVELOPER - 34880
                                </div>
                            </div>
                        </div>  
                    </div>
